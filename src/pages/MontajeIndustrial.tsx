...
import montaje4 from "@/assets/projects/montaje-4.jpg";
import montaje5 from "@/assets/projects/montaje-5.jpg";
...
const MontajeIndustrial = () => {
  const images = [
    ...
    { src: montaje3, title: "Montaje con Grúa Industrial" },
    { src: montaje4, title: "Soldadura Especializada" },
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Especialistas en montaje de estructuras metálicas y soldadura especializada para proyectos industriales de gran envergadura. 
                Nuestro equipo cuenta con la experiencia y certificaciones necesarias para garantizar instalaciones seguras y duraderas.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Contáctenos para discutir los detalles de su próximo proyecto de montaje industrial
            </p>
            <Link
              to="/#contacto"
...
export default MontajeIndustrial;