...
const ObraCivil = () => {
  const images = [
    ...
    { src: civil3, title: "Instalación de Encofrados" },
    { src: civil4, title: "Operaciones de Mezclado" },
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Construcción de estructuras de hormigón de alta complejidad para proyectos industriales y comerciales. 
                Experiencia comprobada en obras de gran escala con los más altos estándares de calidad y seguridad.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-foreground mb-6 uppercase tracking-tight">
              ¿Planea una obra civil?
            </h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Contáctenos para conocer más sobre nuestros servicios de construcción
            </p>
            <Link
              to="/#contacto"
