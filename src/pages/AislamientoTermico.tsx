...
import aislamiento1 from "@/assets/projects/aislamiento-1.jpg";
import aislamiento2 from "@/assets/projects/aislamiento-2.jpg";
import aislamiento3 from "@/assets/projects/aislamiento-3.jpg";
import aislamiento4 from "@/assets/projects/aislamiento-4.jpg";
import aislamiento5 from "@/assets/projects/aislamiento-5.jpg";
import aislamiento6 from "@/assets/projects/aislamiento-6.jpg";

const AislamientoTermico = () => {
  const images = [
    { src: aislamiento1, title: "Instalación de Aislamiento" },
    { src: aislamiento2, title: "Revestimiento Térmico de Calderas" },
    { src: aislamiento3, title: "Aislamiento de Tuberías" },
    { src: aislamiento4, title: "Detalle del Material Aislante" },
    { src: aislamiento5, title: "Acabado con Cladding de Aluminio" },
    { src: aislamiento6, title: "Control de Calidad" },
  ];
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Revestimiento especializado de equipos industriales con materiales aislantes de alta calidad. 
                Nuestros sistemas de aislamiento térmico optimizan la eficiencia energética y protegen sus instalaciones.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Solicite información sobre nuestros servicios de revestimiento térmico
            </p>
            <Link
              to="/#contacto"
